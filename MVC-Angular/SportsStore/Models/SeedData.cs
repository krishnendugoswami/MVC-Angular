...
namespace SportsStore
{
  ...
  public class SeedData
  {
    ...
    {
      context.Database.Migrate();//ensures that the schema in the database is up-to-date before the seed data is applied.
      if (context.Products.Count() == 0)
      {
        ...
        context.SaveChanges(); //Saves the model data to the database
      }
    }
  }
}
